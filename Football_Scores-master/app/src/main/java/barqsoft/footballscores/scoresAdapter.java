...
public class scoresAdapter extends CursorAdapter {
    ...
    public void bindView(View view, final Context context, Cursor cursor) {
        ...
        mHolder.home_name.setContentDescription(context.getString(R.string.home_team, homeTeamName));

        mHolder.away_name.setText(awayTeamName);
        mHolder.away_name.setContentDescription(context.getString(R.string.away_team, awayTeamName));

        mHolder.date.setText(matchTime);
        mHolder.date.setContentDescription(context.getString(R.string.match_time, matchTime));

        mHolder.score.setText(score);
        mHolder.score.setContentDescription(context.getString(R.string.score, score));
        ...
        if (ifShowDetails(mHolder)) {
            ...
            String matchDayDescription = Utilies.getMatchDay(cursor.getInt(COL_MATCHDAY), cursor.getInt(COL_LEAGUE));
            String leagueDescription = Utilies.getLeague(cursor.getInt(COL_LEAGUE));
            ...
            league.setContentDescription(context.getString(R.string.league, leagueDescription));
